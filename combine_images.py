...
def combine_images(output_dir='static'):
    ...
    image_dir = base_dir / 'output' / 'results'
    ...
    first_image_path = image_dir / next(iter(question_map.values()))
